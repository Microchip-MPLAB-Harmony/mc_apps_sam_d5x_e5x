...
# PMSM FOC using hybrid estimator with ZS/MT and BEMF observer
...
This demonstration project is for evaluation purpose only. For more details and support, kindly contact [Microchip Local Sales]()
...
| ----------------- | ---------------------------------------------- | -------------- |
| mclv2_sam_e54_pim.X | MPLABX project for MCLV2 board with ATSAME54 PIM | [Hardware Setup and Running The Application on MCLV2 with ATSAME54 PIM](../docs/mclv2_tc1_atsame54_pim_sensorless.md) |
